  ...
  <div class="nav">
    <div class="w">
      ...
      <ul class="nav-list">
        ...
        <li class="nav-item">
          <a class="link" href="javascript:void(0)" @click.prevent="loadPage('user-center')">我的DevCloud</a>
        </li>
        <li class="nav-item">
          <a class="link" href="javascript:void(0)" @click.preventk="loadPage('about')">关于DevCloud</a>
        </li>
      </ul>
    </div>
  </div>
